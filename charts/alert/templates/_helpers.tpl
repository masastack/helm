...
*/}}
{{- define "alert.labels" -}}
helm.sh/chart: {{ include "alert.chart" . }}
{{ include "alert.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "alert.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "alert.fullname" .) .Values.serviceAccount.name }}
{{- else }}
