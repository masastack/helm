...
*/}}
{{- define "dcc.labels" -}}
helm.sh/chart: {{ include "dcc.chart" . }}
{{ include "dcc.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "dcc.selectorLabels" -}}
app.kubernetes.io/name: {{ include "dcc.name" . }}
...
*/}}
{{- define "dcc.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "dcc.fullname" .) .Values.serviceAccount.name }}
{{- else }}
