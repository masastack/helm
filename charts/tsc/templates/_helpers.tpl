...
*/}}
{{- define "tsc.labels" -}}
helm.sh/chart: {{ include "tsc.chart" . }}
{{ include "tsc.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "tsc.selectorLabels" -}}
app.kubernetes.io/name: {{ include "tsc.name" . }}
...
*/}}
{{- define "tsc.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "tsc.fullname" .) .Values.serviceAccount.name }}
{{- else }}
